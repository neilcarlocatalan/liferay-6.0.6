 ...
 */
public class ImportLARLocalizationTests extends BaseTests {

	public static Test suite() {
		TestSuite testSuite = new TestSuite();

		testSuite.addTestSuite(ImportLARLocalizationTest.class);
		testSuite.addTestSuite(AssertImportLARLocalizationTest.class);
