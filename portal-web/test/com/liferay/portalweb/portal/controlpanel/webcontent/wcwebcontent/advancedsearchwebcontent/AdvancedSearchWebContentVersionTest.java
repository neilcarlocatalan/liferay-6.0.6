 ...
 */
public class AdvancedSearchWebContentVersionTest extends BaseTestCase {
	public void testAdvancedSearchWebContentVersion() throws Exception {
		int label = 1;
		...
		while (label >= 1) {
			...
			case 2:
				...
				for (int second = 0;; second++) {
					...
					try {
						if (selenium.isVisible("_15_version")) {
							break;
						}
					}
					catch (Exception e) {
