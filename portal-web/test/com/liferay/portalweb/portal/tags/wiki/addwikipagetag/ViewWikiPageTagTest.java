...
public class ViewWikiPageTagTest extends BaseTestCase {
	public void testViewWikiPageTag() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.clickAt("link=Wiki Page Title", RuntimeVariables.replace(""));
		selenium.waitForPageToLoad("30000");
		selenium.clickAt("link=wiki1 tag1", RuntimeVariables.replace(""));
		selenium.waitForPageToLoad("30000");
		assertEquals(RuntimeVariables.replace("Pages with tag wiki1 tag1."),
			selenium.getText("//h1[@class='header-title']/span"));
		assertTrue(selenium.isElementPresent("link=Wiki Page Title"));
	}
}